...
public class BookingSystem {
    ...
    private void printMenu() {
        ...
        System.out.println("Дата вылета: " + airplane.getFlightDate());
        ...
        System.out.println("6. Оплатить бронь");
        System.out.println("7. Выход (сохранение)");
        System.out.println("=======================================");
    }

    private void showAllSeats() {
        airplane.checkExpiredBookings();
    ...
    private void payForSeat() {
        try {
            System.out.print("Введите номер места для оплаты: ");
            String seatNumber = scanner.nextLine();
            airplane.getSeat(seatNumber).pay();
            System.out.println("💳 Место " + seatNumber + " успешно оплачено!");
        } catch (SeatNotFoundException | BookingNotFoundException e) {
            System.out.println("⚠ Ошибка: " + e.getMessage());
        }
    }
